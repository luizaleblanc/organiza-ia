  ...
  template: `
    <app-auth-layout>
      <form (submit)="login()" class="space-y-5">
        ...
        <div
          class="text-center mt-8 pt-4 border-t border-slate-100 dark:border-gray-700"
        >
          <p class="text-slate-500 text-sm mb-3">Não tem uma conta?</p>
          <a
            routerLink="/register"
            class="text-[#243a5f] dark:text-blue-300 font-bold text-base hover:underline uppercase"
          >
            INSCREVER-SE
          </a>
        </div>
